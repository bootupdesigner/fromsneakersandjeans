...
const datingandsex = () => {
    ...
    const nextChapter = () => router.push(href = '/chapters/safety');
                            ...
                            <View key={id} style={styles.content}>
                                ...
                                <View style={styles.center} dataSet={{ media: ids.center }}>
                                    <ScrollView showsVerticalScrollIndicator={false}>
                                        ...
                                        {slide.numberList ? slide.numberList.map((point, id) => (
                                ...
                                <View style={styles.right}>
                                    ...
                                    {slide.pinkPosi ?
                                        <Pressable onPress={() => setModalVisible(true)}>
                                            <Image style={styles.navImages} source={pinkPosiImage} accessibilityLabel='pink posi affirmation' />
                                        </Pressable> : null}
                                </View>
